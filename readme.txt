=== Fusion Page Builder : Extension - Copyright ===
...
1. Ensure that you have already installed the [Fusion core](https://wordpress.org/plugins/fusion/) plugin.
2. Install Fusion : Extension - Copyright through the WordPress plugins screen, or upload the plugin files to the `/wp-content/plugins` directory.
3. Activate Fusion : Extension - Copyright through the 'Plugins' screen in WordPress
4. Visit the Fusion knowledge base and user guide at <http://agencydominion.helpscoutdocs.com/>

== Frequently Asked Questions ==

= Does the Fusion : Extension - Copyright plugin require the Fusion core plugin to function? =

Yes. The Fusion : Extension - Copyright plugin is an extension for adding a Copyright element to Fusion. The Fusion core plugin must be installed for this plugin to function. You can get Fusion [here](https://wordpress.org/plugins/fusion/).
...
* Requires Fusion core plugin version 1.1.0 or higher.

= 1.0.1 =
* Security updates.

= 1.0.0 =
* Fusion : Extension - Copyright initial launch.
